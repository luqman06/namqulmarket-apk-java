...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        if (check.equals("settings"))
        {
            ...
            titleQuestions.setText("Please set ansewers for the following sucurity question");
            verifyButton.setText("Set");

            displayPreveriosAnswers();
    ...
    private void setAnswers()
    {
        ...
        {
            Toast.makeText(ResetPasswordActivity.this, "Please ansewer both questions.", Toast.LENGTH_SHORT).show();
    ...
    private void displayPreveriosAnswers()
    {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference()
                .child("Users")
                .child(Prevalent.currentOnlineUser.getPhone());
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (phone.equals(mPhone)) {
                                            ...
                                            if (!newPassword.getText().toString().equals("")) {
                                                ref.child("password")
                                                        ...
                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if (task.isSuccessful()) {
                                                                    Toast.makeText(ResetPasswordActivity.this, "Psssword changed successfully.", Toast.LENGTH_SHORT).show();
                                                                    finish();
                                                                }
                                                            }
                                                        });
                            ...
                            Toast.makeText(ResetPasswordActivity.this, "you hava not set the security question.", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
